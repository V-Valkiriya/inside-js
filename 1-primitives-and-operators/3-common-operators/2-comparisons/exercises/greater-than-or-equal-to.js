...
const _3_actual = 0 >= false;
console.assert(_3_actual === _3_expect, 'Test 3');

const _4_expect = 1 >= 0; // __
const _4_actual = '0.0' >= false;
console.assert(_4_actual === _4_expect, 'Test 4');

const _5_expect = 0 >= true; // __
const _5_actual = false >= true;
console.assert(_5_actual === _5_expect, 'Test 5');

const _6_expect = 1 >= 1; // __
const _6_actual = '13' >= true;
console.assert(_6_actual === _6_expect, 'Test 6');

const _7_expect = 1 >= 2; // __
const _7_actual = 'aa' >= 'ab';
console.assert(_7_actual === _7_expect, 'Test 7');

const _8_expect = 1 >= 1; // __
const _8_actual = 'aa' >= 'aa';
console.assert(_8_actual === _8_expect, 'Test 8');

const _9_expect = false >= false; // __
const _9_actual = 0 >= '';
